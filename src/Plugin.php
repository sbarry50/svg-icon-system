...
use SB2Media\SVGIconSystem\Constants\Constants;
use SB2Media\SVGIconSystem\Setup\Compatibility;
use SB2Media\SVGIconSystem\Setup\I18n;
use SB2Media\SVGIconSystem\Setup\EnqueueManager;
use SB2Media\SVGIconSystem\Setup\Installation;
use SB2Media\SVGIconSystem\EventManagement\PluginAPIManager;
use SB2Media\SVGIconSystem\EventManagement\EventManager;
use SB2Media\SVGIconSystem\File\Loader;
...
class Plugin
{
    ...
    {
        $this->plugin_I18n->setDomain( \SB2Media\SVGIconSystem\Constants\PLUGIN_TEXT_DOMAIN );
    ...
    {
        register_activation_hook( \SB2Media\SVGIconSystem\Constants\PLUGIN_ROOT, array( 'SB2Media\SVGIconSystem\Setup\Installation', 'activate' ) );
        register_deactivation_hook( \SB2Media\SVGIconSystem\Constants\PLUGIN_ROOT, array( 'SB2Media\SVGIconSystem\Setup\Installation', 'deactivate' ) );
        register_uninstall_hook( \SB2Media\SVGIconSystem\Constants\PLUGIN_ROOT, array( 'SB2Media\SVGIconSystem\Setup\Installation', 'uninstall' ) );
    }
}
