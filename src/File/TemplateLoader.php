...
namespace SB2Media\SVGIconSystem\File;

use SB2Media\SVGIconSystem\SVGIcons\SVGIcon;
...
class TemplateLoader extends Loader
{
    ...
    /**
     * Set the SVG Icon dependency
     *
     * @since  1.0.0
     * @param  SVGIcon   $icon   SVGIcon object
     * @return object    $this   Instance of this object
     */
    public function setDependency(SVGIcon $icon)
    {
        $this->icon = $icon;
